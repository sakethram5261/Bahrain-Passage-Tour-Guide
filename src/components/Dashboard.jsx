...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen wood-desk-backdrop pt-10 pb-24 md:pb-28 px-4 md:px-8 flex flex-col items-center justify-center font-sans relative select-none">
